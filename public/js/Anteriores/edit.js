...
function tbmousedown(e)
{
  ...
  this.style.border="solid 1px #cccc33";
...
function tbclick()
{
  ...
  if ((this.id == "forecolor") || (this.id == "hilitecolor")) {
    ...
    imagePath = prompt('Enter Image URL:', 'http://192.168.2.161/uploads/');
...
//var txt = frame.innerHTML;
document.getElementById('texto').value = iFrameBody.innerHTML;
}
function setiframe()
{
   
    var iFrame = document.getElementById('edit');
    $html=document.getElementById('texto').value;
