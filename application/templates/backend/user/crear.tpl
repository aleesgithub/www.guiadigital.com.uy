...
<table class="table">
    ...
    <tr>
        ...
        <td>
            <select class="text" name=language>{html_options options=$language_options selected=$model.language}</select>
        </td>
    </tr> 
    <tr>
        <td >
        ...
        <td>
            <select class="text" name=role><option>-- {$Tr->_("seleccione_rol")} --</option>{html_options options=$roles selected=$model.role}</select>
        </td> 
    </tr>
    <tr>
