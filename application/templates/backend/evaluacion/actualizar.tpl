...
<form action="/evaluacion/actualizar/id/{$id}/" method="post" enctype="multipart/form-data">
...
<table>     
    ...
    <tr>
      <td align="left" colspan="2">
          {$Tr->_("campos_obligatorios")}<input class="btn" type="submit" name="button" id="button" value="{$Tr->_("guardar")|capitalize}"/>
